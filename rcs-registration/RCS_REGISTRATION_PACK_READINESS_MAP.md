...
| Opt-in proof images | Not captured as public URL | Hard stop / build gap | Twilio requires opt-in policy images hosted on a publicly accessible URL. Build or manual process needed to capture and host proof image URLs. |
