...
- `tools/` - local operator helpers, including offline internal-review/proof-pack snapshot checkers and Twilio setup lifecycle guardrails
...
- `RCS_NEXT_SLICE_CHECKLIST_2026-05-23.md` - current next-slice landing page for the real hosted proof-pack and proof-video workflow
