...
- Google Cloud boundary planning recorded:
  ...
  - Cloud Run deployment runbook lives at `rcs-registration/cloud-run/revolut-webhook/DEPLOYMENT_PREP.md`; endpoint proof passed on 2026-05-17 and the Revolut webhook URL has not been changed;
