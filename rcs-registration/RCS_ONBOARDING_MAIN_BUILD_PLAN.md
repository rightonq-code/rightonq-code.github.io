...
- Google Cloud boundary planning recorded:
  ...
  - creating service account keys, additional IAM grants, deploying Cloud Run, changing Revolut webhook URL, automatic Billing writes, and strict payment gating remain explicitly forbidden until approved.
