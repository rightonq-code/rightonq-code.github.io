...
10. Confirm the endpoint will start in record-only mode.
11. Confirm Revolut sandbox webhook URL change will be a separate explicit action after deployment proof.
